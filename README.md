...
Запускается по расписанию через GitHub Actions дважды в день: в 05:17 и 17:17 по Москве. Время подобрано по данным: hh.ru публикует вакансии в основном с 10 до 18, и дневной запуск забирает около 80% дневного потока в тот же день. Утренний подбирает вечер и ночь и приходит без звука. Если какой-то запуск пропустили (у бесплатного крона такое бывает), следующий доберёт неотправленное - повторно ничего не уйдёт.
...
Перенёс запуски на 05:17 и 17:17: дневной забирает около 80% дневного потока в тот же день, утренний - вечер и ночь.
...
<img src="docs/bot-alerts.jpg" width="300" alt="Личный служебный канал: сводка прогона, статус рассылки подписчикам, счётчик подключений">

*Служебный канал: сводка прогона цифрами - сколько новых и из каких источников, сколько ушло подписчикам. Сюда же счётчик подписчиков и тревоги - весь личный контур в одном месте.*
...
| Запуски в 05:17 и 17:17 | Ночью, чтобы подборка ждала утром | hh.ru публикует днём - ночные запуски давали задержку до 14 часов |
